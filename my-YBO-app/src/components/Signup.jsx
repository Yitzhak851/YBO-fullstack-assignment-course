...
function Signup() {
  ...
  async function handleSubmit(e) {
    ...
    try { const response = await fetch("http://localhost:5000/api/auth/signup",
        { 
    ...
    <Box sx={{minHeight: "80vh", display: "flex", justifyContent: "center", alignItems: "center", }}>
      <Card sx={{ width: 350, p: 2 }}>
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary" align="center" sx={{ mb: 4 }} > Sign up for a new account </Typography>
          <form onSubmit={handleSubmit}>
            ...
            <Button fullWidth variant="contained" sx={{ mt: 3 }} type="submit"> Sign Up </Button>
          </form>
        </CardContent>
      </Card>
    </Box>

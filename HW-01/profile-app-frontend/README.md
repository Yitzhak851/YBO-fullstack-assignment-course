<!-- here i write like we saw at th first lecture -->
# Profile App Frontend
This is the frontend part of the profile app assignment. It is built using React and TypeScript. The backend part of the assignment is built using Node.js and Express. The frontend and backend are connected using REST API calls.
...
- `script.js` — fetches `/api/weather?city=...` and populates
the page
- `style.css` — layout and styling
## How it works
1. User types a city name and clicks "Search"
2. `script.js` calls `fetch("/api/weather?city=London")` —
a relative URL
